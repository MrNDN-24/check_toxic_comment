...
print("🎉 Huấn luyện mô hình xong! Bạn có thể nhập câu để kiểm tra mô hình toxic (0: bình thường, 1: độc hại)")
# Nhập câu và dự đoán
sentence = input("Nhập câu bình luận: ")
def result(sentence):
  ...
  return preds
print("➡️ Kết quả dự đoán (1 = độc hại, 0 = bình thường):", result(sentence))
